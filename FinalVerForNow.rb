...
def roomSetup
  ...
  sroom = Room.new("Field","You find yourself in the middle of an open feild.",["Windmill","Shack","TrashPile"],["Feild","Billy Bob"],[])
  ...
  shack = Room.new("Shack", "You see a small shack that is painted baby bird blue with white accents. A lock is holding the doors closed.",["Feild","Windmill"],["Lock"],["Rock","Key"])
